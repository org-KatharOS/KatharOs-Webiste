...
function NavBar() {
  return (
    <div className="h-[8vh] z-10 rounded-4xl border border-white/20 w-[90vw] md:w-[70vw] bg-white/10 backdrop-blur-md shadow-lg backdrop-saturate-150 backdrop-filter-lg fixed self-center mt-[4vh]">
      <div className="h-full w-full flex justify-between items-center px-4 md:px-8">
        ...
        <div className="flex justify-between items-center">
          <Link to="/" className="text-white mx-2 md:mx-4 text-sm md:text-base">Home</Link>
          <Link to="/docs" className="text-white mx-2 md:mx-4 text-sm md:text-base">Docs</Link>
        </div>
      </div>
    </div>
  );
