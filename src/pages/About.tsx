...
const About = () => {
  ...
  const features = [
    {
      ...
      description:
        "Custom Debian ISO with pre-installed Electron app featuring modern React interface and dark noir theme.",
    },
    {
      icon: <Eye className="w-8 h-8" />,
      title: "Smart Device Detection",
      description:
        "Auto-detects and lists all connected drives with detailed information (model, type, size, mount status, device path).",
    },
    {
      icon: <Settings className="w-8 h-8" />,
      title: "Dynamic Wipe Methods",
      description:
        "Method selection based on drive type and encryption status - cryptographic erase for encrypted drives, secure erase for SSDs.",
    },
    {
      icon: <Zap className="w-8 h-8" />,
      title: "Real-time Progress Tracking",
      description:
        "Live progress updates via WebSocket with actual bytes written, percentage calculation, and animated progress bar.",
    },
    {
      icon: <Award className="w-8 h-8" />,
      title: "Tamper-proof Certificates",
      description:
        "Signed certificates stored locally with optional email delivery and SHA-256 hash verification.",
    },
    {
      icon: <Mail className="w-8 h-8" />,
      title: "Email Integration",
      description:
        "Gmail API-based certificate delivery with OAuth2, automatic latest certificate detection, and success confirmation.",
    },
  ];
  ...
  const techStack = [
    {
      category: "Frontend",
      items: ["React 18.2.0", "TypeScript", "Tailwind CSS", "Electron 30.0.1"],
    },
    {
      category: "Backend",
      items: ["Python 3.13+", "WebSocket", "AsyncIO", "psutil"],
    },
    {
      category: "Wiping Tools",
      items: ["dd", "nwipe", "hdparm", "nvme-cli", "cryptsetup"],
    },
    {
      category: "Platform",
      items: ["Custom Debian ISO", "Live-build", "Gmail API", "WeasyPrint"],
    },
  ];
  ...
  const wipingMethods = [
    ...
    },
    {
      ...
      progress:
        "Command completion status, estimated progress for secure erase",
    ...
    },
    {
      ...
      method:
        "Cryptographic erase via key destruction - detects LUKS/Bitlocker encryption and destroys encryption keys",
      verify:
        "Encryption header destruction verification, cryptsetup status checks",
      progress: "Key destruction and header overwrite completion",
      advantage:
        "Instant secure erase regardless of drive size - renders all data unrecoverable",
  ...
  const safetyMeasures = [
    ...
    },
    {
      ...
      description:
        "Graceful handling of device busy, permission, and hardware errors",
  ...
  const timelineSteps = [
    {
      ...
      title: "Boot from ISO",
      userFlow:
        "The process begins when the user boots their computer from the Katharos Debian-based ISO. The Katharos application auto-launches without requiring installation.",
    ...
    },
    {
      ...
      userFlow:
        "Katharos establishes a live connection to its backend, enabling seamless communication.",
    ...
    },
    {
      ...
      title: "Scan Drives",
      userFlow:
        "User clicks 'Scan Drives →' to enumerate all connected storage devices.",
      icon: <Eye className="w-6 h-6" />,
      behindScenes: [
    ...
    },
    {
      ...
      title: "Select Drive",
      userFlow:
        "User selects the desired drive from an interactive data table with keyboard/mouse navigation.",
    ...
    },
    {
      ...
      userFlow:
        "User configures wiping preferences—method (e.g., DoD, Gutmann, Zero-fill), number of passes, and certificate options.",
      icon: <Settings className="w-6 h-6" />,
      behindScenes: [
    ...
    },
    {
      ...
      userFlow:
        "User must confirm their intent through sequential warnings and confirmations before wiping starts.",
      icon: <Shield className="w-6 h-6" />,
      behindScenes: [
    ...
    },
    {
      ...
      userFlow:
        "The wipe process begins with live progress updates and an animated progress bar.",
      icon: <Activity className="w-6 h-6" />,
      behindScenes: [
    ...
    },
    {
      ...
      userFlow:
        "Once the wipe completes, Katharos generates a signed certificate of erasure in multiple formats.",
    ...
    },
    {
      ...
      title: "Completion",
      userFlow:
        "A success screen shows the certificate location and confirms email delivery (if enabled).",
      icon: <CheckCircle className="w-6 h-6" />,
      behindScenes: [
